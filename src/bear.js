...
export function bearContent() {
    ...
    return (
        ...
        <h2 style={{backgroundSize: 'cover', backgroundSize: 'cover', backgroundImage: 'url(https://images.unsplash.com/photo-1593946460607-d1570da6268f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)', padding: '100px 0 100px 0', borderRadius: '10px', width: '60%', color: 'white'}}>Bears: A Fascinating Species</h2>
